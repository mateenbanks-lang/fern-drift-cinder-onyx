...
import { n as GROK_PROVIDERS } from "./router-wTJ_phhm.mjs";
import { i as useCurrentUserState, n as signIn, t as authClient } from "./use-current-user-aGeK05Fx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-tOdV4HOK.js
...
function LoginPage() {
	...
	if (isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", { className: "min-h-dvh bg-bg" });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "mx-auto flex min-h-dvh w-full max-w-md flex-col bg-bg px-4 text-fg",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "safe-top",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/",
					className: "inline-flex py-2 text-base text-muted",
					children: "Back"
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					className: mode === "in" ? "rounded-full bg-inverse py-3.5 text-base font-medium text-inverse-fg" : "rounded-full border border-line py-3.5 text-base font-medium",
					onClick: () => {
						setMode("in");
						setError(null);
					},
					...
					type: "button",
					className: mode === "up" ? "rounded-full bg-inverse py-3.5 text-base font-medium text-inverse-fg" : "rounded-full border border-line py-3.5 text-base font-medium",
					onClick: () => {
						setMode("up");
						setError(null);
					},
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "mt-10 text-center text-3xl font-semibold tracking-tight",
				children: mode === "up" ? "Sign up to mash" : "Sign in to mash"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: busy === "email" ? "Please wait…" : mode === "up" ? "Sign up" : "Sign in"
					})
				]
			})
		]
