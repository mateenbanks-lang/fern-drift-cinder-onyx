...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DQTrXB9c.mjs");
...
var manifest = {
	"b7429131bb7dbea3dfd244af6e5f6df136675bbe9ef2940052e81b46cedcb350": {
		functionName: "editImage_createServerFn_handler",
		importer: () => import("./ai.functions-BazQzmIY.mjs")
	},
	"de950e342c8eb442f49f2dd748d22b98acf97ba6f21b72ba559748b87e4dbf57": {
		functionName: "imagineImage_createServerFn_handler",
		importer: () => import("./ai.functions-BazQzmIY.mjs")
	},
	"e8fdd19ee3278ee72fd45c8a5f79793899ad20afd8c6e425b91c7966fe3b56bb": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-wTJ_phhm.mjs").then((n) => n.t),
